...
const menuItems = [
  {
    name: "Postal Circle",
    link: "/postalcircle/all-postal-circles",
    dropdown: [
      { name: "Create", link: "/postalcircle/create-postal-circle" },
      { name: "See All", link: "/postalcircle/all-postal-circles" },
    ],
  },
  { name: "Community", link: "/postalcircle" },
  { name: "News", link: "/postalcircle" },
  { name: "Events", link: "/postalcircle" },
  { name: "Items", link: "/postalcircle" },
  {
    name: "Orders",
    link: "/postalcircle",
  },
